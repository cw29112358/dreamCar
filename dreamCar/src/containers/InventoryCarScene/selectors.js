...
export const selectDetailCar = createGetSelector(selectInventoryCar, 'detailCar', Immutable.Map());
export const selectIsDetailLoading = createGetSelector(selectInventoryCar, 'isDetailLoading', false);
...
export const selectSingleCar = createSelector(
  ...
  (carInfo, carDetails, similarCars, singleCarConfiguration) => carInfo
...
export const selectCarInfoGroup = createSelector(
  ...
  selectSingleCar,
  selectGetCarIdKey,
  (carInfoGroup, carInfo, key) => carInfoGroup.set(key, Immutable.Map({ [carInfo.get('carId')]: carInfo }))
);
