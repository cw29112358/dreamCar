...
const smallHeight = smallScreen ? 290 : 333;
const scrollHeight = smallScreen ? 200 : 244;
...
export default {
  ...
  header: {
    ...
    width: isPad ? 300 : 200,
    height: isPad ? 60 : 40,
    backgroundColor: commonColor.brownGold,
  ...
  scrollView: {
    ...
    borderBottomWidth: 1,
    borderColor: commonColor.brownGold,
  },
